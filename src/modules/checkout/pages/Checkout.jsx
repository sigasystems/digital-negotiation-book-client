  ...
  import { Check, Building2, User, Mail, Phone, MapPin, CreditCard, Shield, ArrowLeft } from "lucide-react";
                ...
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <CardDescription>Where should we send invoices?</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
