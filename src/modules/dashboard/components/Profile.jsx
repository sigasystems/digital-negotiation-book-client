    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-600 font-medium text-base sm:text-lg">Loading profile details...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-slate-900">No Profile Data</h3>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <div>
                  <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-900">Account Overview</h1>
            ...
            <Card className="border border-slate-200 shadow-sm">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <Badge variant="secondary" className="mt-1 bg-indigo-100 text-indigo-700 border-indigo-300">
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                      <h3 className="font-semibold text-base sm:text-lg text-slate-900">Personal Information</h3>
                  </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                    <InfoField icon={<Mail className="w-4 h-4" />} label="Email" value={backendUser?.email} />
                    <InfoField icon={<Phone className="w-4 h-4" />} label="Phone Number" value={user.phone} />
                    <InfoField icon={<BriefcaseBusiness className="w-4 h-4" />} label="Business Name" value={user.businessName} />
                    <InfoField
            ...
            {plan ? (
              <Card className="border border-slate-200 shadow-sm">
                <CardHeader>
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    <div>
                      ...
                      <CardDescription className="text-xl font-semibold text-indigo-600 mt-1">
                        {payment.amount}
                ...
                <CardContent className="space-y-6">
                    <div className="flex items-center gap-3">
                      <h3 className="font-semibold text-base sm:text-lg text-slate-900">Billing Information</h3>
                    </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                    <InfoField
                    ...
                    />
                    <InfoField icon={<Package className="w-4 h-4" />} label="Billing Cycle" value={plan.billingCycle} />
                    <InfoField icon={<ImportIcon className="w-4 h-4" />} label="Stripe Id" value={plan.stripeProductId} />

                  </div>

                  <div>
                      <div className="flex items-center gap-3 mb-4">
                        <h3 className="font-semibold text-base sm:text-lg text-slate-900">Additional Features</h3>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                        <InfoField icon={<LocationEdit className="w-4 h-4" />} label="Max Locations" value={plan.maxLocations} />
                        <InfoField icon={<BringToFront className="w-4 h-4" />} label="Max Products" value={plan.maxProducts} />
                        <InfoField icon={<CombineIcon className="w-4 h-4" />} label="Max Offers" value={plan.maxOffers} />
                        <InfoField icon={<PercentSquareIcon className="w-4 h-4" />} label="Max Buyers" value={plan.maxBuyers} />
                  ...
                  <div className="flex gap-3 pt-4 flex-wrap">
                    <Button className="flex-1 min-w-[200px] cursor-pointer bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white shadow-md hover:shadow-lg">
                        Manage Subscription
                      </Button>
                    <Button variant="outline" className="flex-1 min-w-[200px] cursor-pointer">
                      View Invoices
                    </Button>
                  </div>
                </CardContent>
              ...
              <Card className="border border-slate-200 shadow-sm">
                <CardContent className="pt-6 text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-slate-900">NoSubscription</h3>
...
const InfoField = ({ icon, label, value }) => (
  <div className="flex items-start gap-3">
    ...
    <div className="min-w-0 flex-1">
      ...
      <p className="text-sm font-medium text-slate-900 truncate">{value || "Not provided"}</p>
    </div>
  </div>
);
