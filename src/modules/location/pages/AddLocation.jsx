    ...
    form.forEach((loc, i) => {
      ...
      if (loc.manualCountry) {
        if (!loc.countryName.trim())
          e[`countryName-${i}`] = "Country name required";
        if (!loc.countryCode.trim())
          e[`countryCode-${i}`] = "Country code required";
      } else {
      ...
      <div className=" mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Add up to 5 locations including country, city, state and
                location code
              </p>
            </div>
          </div>
            ...
            >
              <div className="max-w-sm rounded-lg text-l mb-3 text-red-700 font-bold">
                ...
                {remainingLocations > 0 ? (
                  <span className="text-[#16a34a]">{remainingLocations}</span>
                ) : (
                  "Limit Reach For Locations..."
                )}
              </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            ...
            required. Location codes must be 4 characters or less.
          </p>
        </div>
      </div>
    </div>
